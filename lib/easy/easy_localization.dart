...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ru = {
    ...
    "author": {"male": "{name} - он автор этой книги!", "female": "{name} - она автор этой книги!", "other": "{name} - автор этой книги!"},
    "privacy_policy_url": "https://library.app/privacy_ru.pdf",
    "employees": {"0": "Джон Смит", "1": "Алиса Джонсон", "2": "Майкл Браун", "3": "Эмма Дэвис", "4": "Уильям Тейлор"},
  ...
  static const Map<String, dynamic> en_CA = {
    ...
    "employees": {"0": "John Smith", "1": "Alice Johnson", "2": "Michael Brown", "3": "Emma Davis", "4": "William Taylor"},
    "source": "Generated Easiest Localization"
  };
  ...
  static const Map<String, dynamic> es = {
    ...
    "author": {"male": "¡{name} es el autor de ese libro!", "female": "¡{name} es la autora de ese libro!", "other": "¡{name} es el autor de ese libro!"},
    "privacy_policy_url": "https://library.app/privacy_mx.pdf",
    "employees": {"0": "Juan Smith", "1": "Alicia Johnson", "2": "Miguel Brown", "3": "Emma Davis", "4": "Guillermo Taylor"},
    "source": "Generated Easiest Localization"
  };
